...
function IndexHeader({filter, setFilter, setSearchText }) {
    ...
    const handleSearchInnputOnChange = (e) => {
    ...
    const handleSerachButtonOnClick = (e) => {
        setSearchText(searchInputValue);
    }
    ...
    return (
        <>
            <div css={s.container}>
                <input css={s.searchInput} type="text" value={searchInputValue} onChange={handleSearchInnputOnChange} onKeyDown={handleSearchInputOnkeyDown}/>
                <button css={s.searchButton} onClick={handleSerachButtonOnClick}><IoSearch /></button>
            </div>
